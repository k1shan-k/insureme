            ...
            <article className="lg:col-span-9">
              ...
              <div className="mt-16 border-t border-line pt-8">
                <p className="max-w-3xl text-[13px] leading-relaxed text-slate-faint">
                  ...
                  constitute legal advice or a contract. Insurance products and
                  coverage are subject to applicable policy terms, conditions,
                  limitations and exclusions. In the event of any inconsistency,
