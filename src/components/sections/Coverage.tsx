...
export function Coverage() {
  return (
    <section id="coverage" className="scroll-mt-24 border-t border-line bg-ivory-50 py-24 lg:py-32">
      <div className="container-x">
        <div className="reveal grid gap-8 lg:grid-cols-12 lg:items-end">
          ...
          <p className="max-w-sm text-[15px] leading-relaxed text-slate-muted lg:col-span-4">
            Each line is underwritten independently against defined risk parameters, with limits
            and conditions structured to the insured environment.
          </p>
        </div>
        ...
        <div className="reveal mt-14 grid border-l border-r border-line sm:grid-cols-2 lg:grid-cols-3">
          {coverage.map((c) => (
            <CoverageCard
              ...
              icon={renderIcon(c.icon, "h-7 w-7")}
            />
          ))}
        </div>
